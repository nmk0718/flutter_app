  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text('MyMusicPlayer',
              style: TextStyle(color: Color(0xFFFE1483), fontFamily: "Nexs")),
          centerTitle: true,
          actions: <Widget>[
            IconButton(
        ...
        body: Column(
          children: <Widget>[
            ...
            Column(children: <Widget>[
              Text("Justion Biebar fit. Never say", style: TextStyle(
                  color: Color(0xFFFE1483),
                  fontSize: 20.0,
                  fontFamily: "Nexa"),),
              SizedBox(height: 8.0,),
              Text("The Weeknd", style: TextStyle(
                  color: Color(0xFFFE1483),
                  fontSize: 18.0,
                  ...
                  Center(
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        song("assets/cover_03.jpg", "Boyfriend", "Believe 2012")
                      ],
                    ),
                  ),
                ],
...
Widget song(String image,String title,String subtitle){
  ...
  child: Row(
    mainAxisAlignment: MainAxisAlignment.center,
    children: <Widget>[
      Image.network("https://",height: 40.0,width: 40.0,),
      SizedBox(width: 8.0,),
      Column(
